...
/*                                                  +#+                       */
/*   Created: 2024/05/07 12:08:45 by fvan-wij      #+#    #+#                 */
/*   Updated: 2024/05/07 12:08:46 by fvan-wij      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	mouse_input(t_app *cbd)
{
	...
	rotate_player(&cbd->playerdata, cbd->particles,
		delta_x * 0.05 * delta_time);
