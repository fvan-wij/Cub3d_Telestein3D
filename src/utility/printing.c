...
// 		}
// 		i = 0;
// 		// while (i < cub3d->mapdata->walls.n_cw
//&& cub3d->mapdata->walls.cw_path[i])
// 		// {
...
//tex_path[WE]: %s\n
//tex_path[EA]: %s\n",
//cub3d->mapdata->walls.w_path[NO],cub3d-> mapdata->walls.w_path[SO],
//cub3d->mapdata->walls.w_path[WE], cub3d->mapdata->walls.w_path[EA]);
// 	ft_printf("\n[COLORS]\nFloor color:  (%d, %d, %d)\n
//Ceiling color: (%d, %d, %d)\n",
//cub3d->mapdata->floor.r, cub3d->mapdata->floor.g, cub3d->mapdata->floor.b,
//cub3d->mapdata->ceiling.r, cub3d->mapdata->ceiling.g,
//cub3d->mapdata->ceiling.b);
...
//c, cub3d->mapdata->width, cub3d->mapdata->height);
//
...
// 			while ((int)curr->destinations[j].x != 0
//|| (int)curr->destinations[j].y != 0)
// 			{
// 				printf("->(%d, %d) ", (int)curr->destinations[j].x,
//(int)curr->destinations[j].y);
// 				j++;
// 			}
// 			printf("\n");
// 		}
